    ...
    public partial class initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActorNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoryNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanTypeNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MembershipCategoryNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProducerNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudioNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MemberNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MembershipCategoryNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DVDNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CategoryNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudioNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProducerNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    DateReleased = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StandardCharge = table.Column<decimal>(type: "decimal(9,2)", nullable: false),
                    PenaltyCharge = table.Column<decimal>(type: "decimal(9,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CopyNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DVDNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LoanTypeNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CopyNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MemberNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
